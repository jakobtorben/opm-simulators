...
#ifndef OPM_MULTITHREADDILU_HEADER_INCLUDED
#define OPM_MULTITHREADDILU_HEADER_INCLUDED
 ...
 *  \details Parallelized implementation using OpenMP and graph coloring.
